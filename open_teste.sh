...
if [[ -e /etc/openvpn/server.conf ]]; then
	...
	clear
    echo -e "\033[01;35m -------------------------------------------------"
    echo -e "\033[01;35m|                  \033[01;33m    OPENVPN\033[01;35m                   |"
    echo -e "\033[01;35m -------------------------------------------------"
		echo ""
		echo -e "\033[01;32m  1 \033[01;35m•\033[01;33m CRIAR USUARIOS."
		echo -e "\033[01;32m  2 \033[01;35m•\033[01;33m REMOVER UM USUARIO."
		echo -e "\033[01;32m  3 \033[01;35m•\033[01;33m DESINSTALAR OpenVPN"
		echo -e "\033[01;32m  0 \033[01;35m•\033[01;33m MENU INICIAL"
		echo -ne "\033[1;33m  OPÇÃO \033[01;32m[1-3]\033[1;37m:"; read option
		case $option in
			1) 
			echo ""
echo -e "\033[01;35m---------------------------------------"
echo -ne "\033[01;32mNOME DO USUÁRIO:\033[01;33m"; read CLIENT
if [ -z $CLIENT ]; then
  echo ""
...
if echo $CLIENT | grep -q '[^a-z A-Z 0-9 ._-]'; then
  echo ""
  echo -e "\033[01;37;41mVocê digitou um nome de usuário inválido. Use apenas letras, números\033[0m"; echo -e "\033[01;37;41mpontos e traços. Não use espaços, acentos ou caracteres especiais. T\033[0m"; echo -e "\033[01;37;41mente novamente!                                                     \033[0m"
  sleep 3s
  open
  exit
else
...
if [ -z $DAYS ]; then
  ...
  echo -e "\033[01;35m---------------------------------------"
  echo -e "\033[01;32mNome do usuário:\033[01;33m $CLIENT"
