...
if [[ -e /etc/openvpn/server.conf ]]; then
    ...
    clear
        ...
        case $option in
            ...
            newclient "$CLIENT"
            echo ""
            echo "Cliente $CLIENT adicionado, certificado disponíveis em $homeDir/$CLIENT.ovpn"
            exit
            ;;
            2)
            ...
            echo ""
            echo "Certificado para o cliente $CLIENT revoked"
            echo "Saindo..."
            exit
            ;;
            3)
    ...
    echo "Se o seu servidor estiver funcionando atrás de um NAT, (e.g. LowEndSpirit, Scaleway) deixe o endereço IP como ele é. (local/private IP)"
